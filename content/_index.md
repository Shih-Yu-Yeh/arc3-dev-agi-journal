...
- [Lessons Learned](/lessons-learned/) — 16 條開發憲法 + 5 個最大技術教訓
- [About](/about/) — 作者簡介、技術棧、聯絡
- [Posts](/posts/) — 每篇對應一次提交，按時間順序

## 依結果快速導覽

**從這裡開始**：[序言 — Kaggle 平台與 ARC-AGI-3 簡介](/posts/2026-07-30-arc3-prologue-kaggle-and-arc-agi-3/)
...
**得來不易的 calibration**：[V10 (純 baseline replica)](/posts/2026-08-09-arc3-v10-rokaiya-baseline/)
